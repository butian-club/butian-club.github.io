...
export const stats: Stat[] = [
  {
    ...
    value: '2024',
    labelZh: 'GFSSM 中国站亚军',
    labelEn: 'GFSSM China Runner-up',
    captionZh: '求是创新学院步天工程社',
    captionEn: 'Qiushi Innovation Academy · Butian',
  },
  {
    id: 'teams',
    value: '2',
    labelZh: '晋级全国决赛队伍',
    labelEn: 'Teams in the National Final',
    captionZh: '玉衡队 · 天权队',
    captionEn: 'Team Yuheng · Team Tianquan',
  },
  {
    id: 'honors',
    value: '5+',
    labelZh: '团队与个人荣誉',
    labelEn: 'Team & Individual Honors',
    captionZh: '最佳提案 · 最佳领导者 · 最佳员工 等',
    captionEn: 'Best Proposal · Best Leader · Best Employee, etc.',
  },
  {
    id: 'since',
    value: '2016',
